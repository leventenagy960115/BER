...
set rc [catch {
  ...
  add_files -quiet C:/Levi_Dok/Egyetem/Mesteri/I_EV/I_FELEV/BeagyazottRendszerek/SmartWateringSystem_IPintegrated/SmartWateringSystem_IPintegrated.runs/synth_1/design_1_wrapper.dcp
